...
def main():
    ...
    with tab4:
        ...
        end_date = next_date + pd.DateOffset(days=num_days)
        future_dates = pd.bdate_range(start=next_date, end=end_date - pd.DateOffset(days=1))
        ...
        fig.update_layout(
            title='EUR/USD Value Prediction for the Next {} Days'.format(num_days),
            xaxis_title='Date',
